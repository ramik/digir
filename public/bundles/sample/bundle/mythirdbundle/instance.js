...
function() {
    ...
    startExtension : function() {
        var me = this;
        this.plugins['Oskari.userinterface.Flyout'] = Oskari.clazz.create('Oskari.sample.bundle.mythirdbundle.Flyout', this);
        this.plugins['Oskari.userinterface.Tile'] = Oskari.clazz.create('Oskari.sample.bundle.mythirdbundle.Tile', this);
    },
